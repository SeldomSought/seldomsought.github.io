...

  {
    ...
    components: [
      ...
      },
      {
        ...
        type: 'features',
        content: [
          'Journey through 14 conceptual regions — 12 charted with real content, from Orientation through Synthesis; Relationships and Constraints remain uncharted',
          '11 distinct measurement formats: Likert, frequency, forced-choice ranking, tradeoffs, rankings, scenarios, behavioral history, confidence checks, aspirational pairs, and optional written reflection',
